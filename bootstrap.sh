...
# bootstrap.sh - One-time dotfiles provisioning for a new macOS machine
# Usage: ./bootstrap.sh [--force] [--skip-brew]
...
main() {
  ...
  log_info "Bootstrap complete! Restart your terminal or run: exec zsh -l"
}
